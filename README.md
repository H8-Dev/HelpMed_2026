...
- 5 -> Criação de gráfico customizável 🟡 <br>
- 6 -> Navegador de arquivos para achar informações 🟠 <br>
- 7 -> Exibir um resumo das fichas providas pelo usuário 🔴 <br>
- 8 -> Troca de tela de chat salvando a atual 🟡 <br>
- 9 -> O sistema deve enviar lembretes para os pacientes 🔴 <br>
- 10 -> O sistema deve permitir o paciente informar seus problemas 🟡 <br>

<p>Dava para ter quebrado as funcionalidades em outras e agora minha ambição irá me comer vivo 😔 - H8</p>
